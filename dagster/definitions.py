...
from dagster_portada_project.assets import boat_fact_ingestion_assets, entity_ingestion_assets, boat_fact_cleaning_assets
...
def callback_error(param, log):
    ...
    elif param["asset"] in [*boat_fact_all_assets, *entity_all_assets]:
        if param["asset"] not in ["update_data_base_for_entity", "update_data_base_for_entry"]:
